        ...
        <AuthenticatedLayout
            ...
            header={
                <div className="flex flex-col md:flex-row justify-between md:items-center gap-4">
                    <div>
                        <h2 className="font-bold text-2xl text-gray-800 leading-tight">Assistance Programs</h2>
                        <p className="text-sm text-gray-500 mt-1">Manage the services displayed on the public landing page.</p>
                    </div>
                    <button
                        onClick={openCreateModal}
                        className="inline-flex items-center px-5 py-2.5 bg-blue-700 hover:bg-blue-800 text-white font-semibold text-sm rounded-lg shadow-md transition-all transform hover:-translate-y-0.5"
                    >
        ...
        >
            ...
            <div className="py-12 bg-gray-50 min-h-screen">
                <div className="max-w-7xl mx-auto sm:px-6 lg:px-8">
                    ...
                    {/* --- TOOLBAR --- */}
                    <div className="bg-white p-4 rounded-t-xl border-b border-gray-200 flex items-center justify-between shadow-sm">
                        <div className="relative w-full max-w-md">
                            ...
                            <input
                                type="text"
                                className="block w-full pl-10 pr-3 py-2 border border-gray-300 rounded-lg leading-5 bg-gray-50 placeholder-gray-500 focus:outline-none focus:placeholder-gray-400 focus:border-blue-500 focus:ring-1 focus:ring-blue-500 sm:text-sm transition"
                    ...
                    {/* --- TABLE --- */}
                    <div className="bg-white overflow-hidden shadow-sm rounded-b-xl border border-t-0 border-gray-200">
                        <div className="overflow-x-auto">
                            <table className="min-w-full divide-y divide-gray-200">
                                <thead className="bg-gray-50">
                                    <tr>
                                        <th className="px-6 py-4 text-left text-xs font-bold text-gray-500 uppercase tracking-wider w-20">Icon</th>
                                        <th className="px-6 py-4 text-left text-xs font-bold text-gray-500 uppercase tracking-wider">Program Title</th>
                                ...
                                <tbody className="bg-white divide-y divide-gray-200">
                                    {filteredPrograms.length > 0 ? (
                                        filteredPrograms.map((program) => (
                                            <tr key={program.id} className="hover:bg-blue-50 transition-colors duration-150 group">
                                                <td className="px-6 py-4 whitespace-nowrap">
                                                    <div className="h-10 w-10 rounded-full bg-blue-100 flex items-center justify-center text-blue-600 shadow-sm border border-blue-200">
                                                ...
                                                <td className="px-6 py-4">
                                                    <div className="text-sm text-gray-500 max-w-lg truncate" title={program.description}>
                                                        {program.description}
                                                    </div>
                                                </td>
            ...
            <Modal show={isModalOpen} onClose={closeModal}>
                <form onSubmit={submit} className="p-6">
                    ...
                    <div className="mb-6">
                        <InputLabel htmlFor="icon_path" value="SVG Icon Path" />
                        <div className="flex gap-4 items-start">
                            ...
                            <div className="mt-1 h-10 w-10 rounded bg-blue-50 border border-blue-200 flex items-center justify-center text-blue-600 shrink-0">
                                <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <div className="flex justify-end gap-3 pt-4 border-t">
                        ...
                        <PrimaryButton disabled={form.processing} className="bg-blue-700 hover:bg-blue-800">
            ...
            <Modal show={isDeleteModalOpen} onClose={closeModal}>
                <div className="p-6 text-center">
                    ...
                    <h2 className="text-xl font-bold text-gray-900 mb-2">Delete Program?</h2>
