...
export default function ApplicationShow({ application }) {
    ...
    const submitRemark = (e) => {
        e.preventDefault();
        post(route('applications.remarks.store', application.id), {
            preserveScroll: true,
            onSuccess: () => {
    ...
    const submitApprove = (e) => {
        e.preventDefault();
        approveForm.post(route('applications.approve', application.id), {
            preserveScroll: true,
            onSuccess: () => {
            ...
            header={
                <div className="flex flex-col md:flex-row md:justify-between md:items-center gap-4">
                    ...
                    <div className="flex flex-wrap items-center gap-3">
                        <Link href={route('applications.index')} className="text-gray-500 hover:text-gray-700 flex items-center pr-3 border-r border-gray-300">
