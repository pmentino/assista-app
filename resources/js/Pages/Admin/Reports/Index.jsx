...
export default function ReportsIndex({ applications, filters: initialFilters, stats, allBarangays, programs }) {
                    ...
                    <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden transition-colors duration-300">
                        ...
                        <div className="p-6 border-b border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800 flex flex-col md:flex-row justify-between items-center gap-4">
                            <div>
                                ...
                                <p className="text-sm text-gray-500 dark:text-gray-400">View and export applications based on specific criteria.</p>
                            </div>
                        ...
                        <div className="p-6 grid grid-cols-1 md:grid-cols-6 gap-4 bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
                            ...
                            <div className="col-span-1">
                                ...
                                <select value={period} onChange={handlePeriodChange} className="block w-full border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white rounded-md shadow-sm text-sm cursor-pointer focus:ring-blue-500 focus:border-blue-500">
                            ...
                            <div className="col-span-2 grid grid-cols-2 gap-2">
                                <div>
                                    ...
                                    <input type="date" name="start_date" value={filters.start_date} onChange={handleFilterChange} className="block w-full border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white rounded-md shadow-sm text-sm focus:ring-blue-500 focus:border-blue-500" />
                                </div>
                                <div>
                                    <label className="block text-xs font-bold text-gray-500 dark:text-gray-400 uppercase mb-1">To</label>
                                    <input type="date" name="end_date" value={filters.end_date} onChange={handleFilterChange} className="block w-full border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white rounded-md shadow-sm text-sm focus:ring-blue-500 focus:border-blue-500" />
                                </div>
                            </div>
                            ...
                            <div className="col-span-1">
                                ...
                                <select name="barangay" value={filters.barangay} onChange={handleFilterChange} className="block w-full border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white rounded-md shadow-sm text-sm cursor-pointer focus:ring-blue-500 focus:border-blue-500">
                            ...
                            <div className="col-span-1">
                                ...
                                <select name="status" value={filters.status} onChange={handleFilterChange} className="block w-full border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white rounded-md shadow-sm text-sm cursor-pointer focus:ring-blue-500 focus:border-blue-500">
                            ...
                            <div className="col-span-1">
                                ...
                                <select name="program" value={filters.program} onChange={handleFilterChange} className="block w-full border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white rounded-md shadow-sm text-sm cursor-pointer focus:ring-blue-500 focus:border-blue-500">
                                    ...
                                    {appList.length > 0 ? (
                                        appList.map((app) => (
                                            <tr key={app.id} className="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors">
                                                ...
                                                <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-600 dark:text-gray-300">{app.program}</td>
