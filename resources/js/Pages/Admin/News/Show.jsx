...
export default function Show({ news, auth }) {
    if (!news) return <div className="text-center py-20 text-gray-500">Loading article...</div>;

    return (
        <div className="min-h-screen bg-gray-50 font-sans text-gray-900 antialiased">
            <Head title={news.title} />

            {/* --- PUBLIC HEADER (Consistent with Welcome Page) --- */}
            <header className="bg-blue-800 shadow-md sticky top-0 z-50">
                <div className="container mx-auto flex items-center justify-between p-4 px-6">
                    <Link href="/" className="flex items-center gap-3 group">
                        <img src="/images/logo.png" alt="Logo" className="h-10 w-auto bg-white rounded-full p-1 group-hover:scale-105 transition-transform" />
                ...
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="mb-8">
                        <Link
                            ...
                            className="inline-flex items-center text-gray-500 hover:text-blue-800 font-bold transition-colors group"
                        >
                        ...
                        <div className="p-8 md:p-12">
                            ...
                            <div className="flex items-center gap-4 text-sm text-gray-500 mb-6 border-b border-gray-100 pb-6">
                                <span className="flex items-center">
                                    ...
                                    {new Date(news.created_at).toLocaleDateString(undefined, { weekday: 'long', year: 'numeric', month: 'long', day: 'numeric' })}
                                </span>
            ...
            <footer className="bg-blue-900 text-white py-8 text-center mt-12">
                <p className="text-sm opacity-75">&copy; {new Date().getFullYear()} City Social Welfare and Development Office. All rights reserved.</p>
            </footer>
        </div>
    );
}
