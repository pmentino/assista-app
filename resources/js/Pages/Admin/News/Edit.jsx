                                ...
                                <div className="border-t pt-6">
                                    ...
                                    <div className="flex flex-col md:flex-row gap-8 items-start">
                                        ...
                                        <div className="w-full md:w-1/3">
                                            <div className="aspect-video bg-gray-100 rounded-lg border flex items-center justify-center overflow-hidden relative shadow-inner">
                                                {imagePreview ? (
                                            ...
                                            <p className="text-xs text-center text-gray-500 mt-2">Current / Preview</p>
                                        </div>
