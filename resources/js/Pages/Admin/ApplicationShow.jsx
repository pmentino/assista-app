...
// 1. Receive 'programSettings' here
export default function ApplicationShow({ application, programSettings }) {
    ...
    // 2. Form for Approval (Amount) - Initialize with Default Amount
                                        ...
                                        <>
                                            ...
                                            <div className="mt-4 flex justify-end">
                                                <a
                                                    ...
                                                    className="inline-flex items-center px-4 py-2 bg-green-700 border border-transparent rounded-md font-bold text-xs text-white uppercase tracking-widest hover:bg-green-800 focus:bg-green-700 active:bg-green-900 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 transition ease-in-out duration-150 shadow-md"
                                                >
                            ...
                            <div className="bg-white p-6 rounded-xl shadow-2xl w-full max-w-md">
                                ...
                                <form onSubmit={submitApprove}>
                                    <div className="mb-4">
                                        ...
                                        {/* 3. SMART TIP: Show Default Amount if available */}
                                        {programSettings?.default_amount && (
                                            <div className="mb-2 p-2 bg-blue-50 text-blue-700 text-xs rounded border border-blue-100 flex items-center">
