...
export default function ApplicationsIndex({ auth, applications, filters: initialFilters = {}, sort_by: initialSortBy, sort_direction: initialSortDirection, allBarangays, programs }) {
    ...
    const getStatusColor = (status) => {
        switch (status) {
            ...
            case 'Verified': return 'bg-purple-100 dark:bg-purple-900/30 text-purple-800 dark:text-purple-300 border-purple-200 dark:border-purple-800'; // <-- ADD THIS LINE
            default: return 'bg-yellow-100 dark:bg-yellow-900/30 text-yellow-800 dark:text-yellow-300 border-yellow-200 dark:border-yellow-800'; // Default is now specifically for 'Pending'
        }
    };
